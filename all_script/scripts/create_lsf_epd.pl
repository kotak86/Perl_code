...
$dir = "/proj/xtcRepo/ipv/epdIP/$ENV{REL}/$run_type/_TCASE/edkIP";
$dir_nt = "G:\\xtcRepo\\ipv\\dspIP\\$ENV{REL}\\$run_type\\_TCASE\\edkIP"; # Make sure the path is visible from all windows machine for LSF job #
